...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  6 01:55:15 2024
...
# Read the CSV file
file_path = 'em_max.csv'  # replace with your file path
...
plt.scatter(range(len(col1)), col1, label='emWave Pro', color='blue')
plt.scatter(range(len(col2)), col2, label='max30003', color='red')
